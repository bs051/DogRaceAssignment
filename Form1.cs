...
using DogRaceAssignment.MyClasses;

namespace DogRaceAssignment
{
    public partial class Form1 : Form
    {
        ...
        {
            // Dogs Info
            dogz[0] = new Dog() { DogName = "Dog 1", RaceTrackLength = 930, MyPictureBox = pictureBox1 };
            dogz[1] = new Dog() { DogName = "Dog 2", RaceTrackLength = 930, MyPictureBox = pictureBox2 };
            dogz[2] = new Dog() { DogName = "Dog 3", RaceTrackLength = 930, MyPictureBox = pictureBox3 };
            dogz[3] = new Dog() { DogName = "Dog 4", RaceTrackLength = 930, MyPictureBox = pictureBox4 };
